...
if __name__=="__main__":
    ...
    train_pt_dataset = NuscenesEval(args.trainval_data_path, version = args.data_version, split = 'train', vis=True, voxelizer=voxelizer, use_z=use_z, mode=mode, allocentric_angle=allocentric_angle)
    val_pt_dataset = NuscenesEval(args.trainval_data_path, version = args.data_version, split = 'val',vis =True, voxelizer=voxelizer, use_z=use_z, mode=mode, allocentric_angle=allocentric_angle)
    ...
    for k in samples:
        ...
        if polar_histogram:
            ...
            print(f"JJJJJJJJJJSD   jsd: {jsds_gen}                  ==================scene {k}")
