...
def main(args):
    ...
    train_pt_dataset = Nuscenes(data_path, version = 'v1.0-mini', split = 'train', return_ref = True)
    val_pt_dataset = Nuscenes(data_path, version = 'v1.0-mini', split = 'val', return_ref = True)
    if model == 'polar':
        print('Using polar model')
    ...
    print('Data prepared .... loading model...')
    print(f"num unique label: {len(unique_label)}")
...
if __name__ == '__main__':
    ...
    # change batch sizes to 1 to avoid cuda out of memory error
