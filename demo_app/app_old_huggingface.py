...
# dataset = load_dataset("Shing-Hei/Nuscenes-mini-subset")
# print(dataset)
...
################# load object library
obj_library_path = "./foreground_object_pointclouds"

with open(os.path.join(obj_library_path, "allocentric.pickle"), 'rb') as handle:
...
demo = DemoApp(allocentric_dict, obj_library_path, train_dataset, val_dataset, mask_git, voxelizer, device, mode)
demo.launch()
